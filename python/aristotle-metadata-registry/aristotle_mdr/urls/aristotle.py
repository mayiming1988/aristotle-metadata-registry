...
urlpatterns=[
    ...
    url(r'^toolbox/compare/?$', views.comparator.CompareConceptsView.as_view(), name='compare_concepts'),
    url(r'^toolbox/compare2/?$', views.tools.MetadataComparison.as_view(), name='compare_concepts2'),

...
class BaseStewardOrgsTestCase(utils.AristotleTestUtils):
    def setUp(self):
        ...
        self.org_manager = User.object.create(
        ...
        self.org_steward = User.object.create(
        ...
        self.org_member = User.object.create(
...
class OrgPermissionsTests(BaseStewardOrgsTestCase, TestCase):
    ...
    def test_admin_permissions(self):
        ...
        for permission_name, is_permitted in org_1_role_permissions:
            self.assertEqual(
                self.steward_org_1.user_has_permission(permission_name),
                is_permitted,
                msg="User permission failed for - %s" % permission_name
            )

    def test_admin_can_create_workgroup(self):
        pass

    def test_admin_can_create_registration_authority(self):
        pass

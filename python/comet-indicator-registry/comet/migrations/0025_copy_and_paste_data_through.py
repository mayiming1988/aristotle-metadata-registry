...
def copy_and_paste_data_from_old_through_table_to_new(apps, schema_editor):
    ...
    data_copy_and_paste_from_one_through_table_to_another(indicator_model, through_model, 'dimensions', 'dimensions_new')
...
def copy_and_paste_data_from_new_through_table_to_old(apps, schema_editor):
    ...
    data_copy_and_paste_from_one_through_table_to_another(indicator_model, through_model, 'dimensions_new', 'dimensions')

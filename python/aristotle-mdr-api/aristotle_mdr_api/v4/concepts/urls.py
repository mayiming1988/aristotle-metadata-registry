...
urlpatterns = [
    url(r'^(?P<pk>\d+)/update-permissions/$', views.UpdateVersionPermissionsView.as_view(), name="update-version-permissions"),
    url(r'^(?P<pk>\d+)/view-permission/(?P<vpk>\d+)/$', views.GetVersionsPermissionsView.as_view(), name='view-version-permissions'),
